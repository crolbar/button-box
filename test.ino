...
void CheckALLButtonG(void){  //===========================BUTTONS==========================
  ...
  byte keystate = buttx.getState(); 
    ...
    if (key == red_bt){                   //
      Keyboard.println("red_bt");

    }
    if (key == red_tp){                   // 
      Keyboard.println("red_tp");

    } 

    if (key == ONETS1_UP){              //
      Keyboard.println("ONETS1_UP");

    }
    if (key == ONETS2_UP){              //
      Keyboard.println("ONETS2_UP");

    }
    if (key == TS1_UP){                 //
      Keyboard.println("TS1_UP");

    }
    if (key == TS2_UP){                 //
      Keyboard.println("TS2_UP");

    }
    if (key == TS3_UP){                 //
      Keyboard.println("TS3_UP");
    
    }
    
    if (key == TS1_DOWN){               //
      Keyboard.println("TS1_DOWN");

    }
    if (key == TS2_DOWN){               //
      Keyboard.println("TS2_DOWN");

    }
    if (key == TS3_DOWN){               //
      Keyboard.println("TS3_DOWN");

    }
    if (key == blk1){                   //     
      Keyboard.println("blk1");

    }
    if (key == blk2){                   //
      Keyboard.println("blk2");

    }
    if (key == blk3){                   //
      Keyboard.println("blk3");

    }
    if (key == blk4){                   //
      Keyboard.println("blk4");

    }
    if (key == blk5){                   //
      Keyboard.println("blk5");
